                ...
                <div class="p-5">
                  ...
                  <form class="user" action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="us_name" name="us_name" required="required" autofocus="autofocus" placeholder="Nombre de usuario" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="us_password" name="us_password" required="required" placeholder="Contraseña">
                    </div>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="<?php echo URL; ?>log/restablecer">¿Olvidaste tu contraseña?</a>
                  </div>
                </div>
              </div>
            </div>
