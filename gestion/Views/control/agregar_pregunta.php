					...
					<div class="form-row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="form-label-group">
								...
								<input type="text" id="preg_descripcion" name="preg_descripcion" class="form-control" placeholder="Escriba una nueva pregunta..." required="required" autocomplete="off" value="">
							</div>
						</div>
					</div>
				</div>
