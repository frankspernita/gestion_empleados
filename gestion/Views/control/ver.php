...
<?php include 'h_barra.php'; ?>
  ...
  <div id="wrapper">
    <!-- Begin Page Content -->
      ...
      <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Ver item</h1>
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-4 col-lg-8">
                        ...
                        <div class="table-responsive">
                          <table id="items" name="items" class="table table-bordered col-mb-12">
                            <thead>
                            <h4>Items de la categoría</h4>
                              <tr style="background-color: #ffad88">
                                <td><center><strong>Subcategoría</strong></center></td>
                            ...
                            while ( $row = mysqli_fetch_array($datos)){ ?>
                              ...
                              <tr bgcolor="#fffaeb">
                                <td id="it_nombre"><?php echo $row['it_nombre']; ?></td>
                                <td id="it_descripcion"><?php echo $row['it_descripcion']; ?></td>
                                <td align=center>
                                    <a href="<?php echo URL; ?>control/editar/<?php echo $row['iditem']; ?>" class="btn btn-primary btn-md" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-pencil-alt"></i></a></td>
                                <td align=center>
                                    <a data-toggle="modal" href="#eliminar" data-target="#eliminarModalCenter<?php echo $row['iditem']; ?>" id="<?php echo $row['iditem']; ?>" class="btn btn-primary btn-md"><i class="fas fa-trash-alt" data-toggle="tooltip" data-placement="top" title="Eliminar"></i></a>
                                </td>
                            <!-- el id del modal debe ser el mismo que el data target del boton-->
                            <div class="modal fade" id="eliminarModalCenter<?php echo $row['iditem'];?>" tabindex="-1" role="dialog" aria-labelledby="eliminarModalCenterTitle" aria-hidden="true"> 
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="<?php echo URL; ?>control/eliminar/<?php echo $row['iditem'] ; ?>" class="btn btn-primary">Eliminar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>           
