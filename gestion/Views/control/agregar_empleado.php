                ...
                <div class="form-row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="form-label-group">
                            ...
                            <input type="text" id="emp_apellido" name="emp_apellido" class="form-control" placeholder="Apellido del empleado" autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="form-label-group">
                            <label for="emp_nombre"><small>Nombre</small></label>
                            <input type="text" id="emp_nombre" name="emp_nombre" class="form-control" placeholder="Nombre del empleado" required="required" autocomplete="off" value="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="form-label-group">
                            ...
                            <input type="number" id="emp_dni" name="emp_dni" class="form-control" placeholder="DNI del empleado" autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="form-label-group">
                            <label for="emp_celular"><small>Celular</small></label>
                            <input type="number" id="emp_celular" name="emp_celular" class="form-control" placeholder="Celular del empleado" autocomplete="off" value="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="form-label-group">
                            ...
                            <input type="text" id="idpuesto" name="idpuesto" class="form-control" placeholder="Puesto del empleado" autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="form-label-group">
                ...
                <div class="form-row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="form-label-group">
                            ...
                            <input type="text" id="emp_legajo" name="emp_legajo" class="form-control" placeholder="Legajo del empleado" autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="form-label-group">
                            <label for="emp_domicilio"><small>Domicilio</small></label>
                            <input type="text" id="emp_domicilio" name="emp_domicilio" class="form-control" placeholder="Domicilio del empleado" autocomplete="off" value="">
                        </div>
                    </div>
                </div>
            </div>
