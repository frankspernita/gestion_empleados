<body id="page-top">
	...
	<div id="wrapper">
		...
		<div class="container-fluid">
			<!-- Page Heading -->
			<h1 class="h3 mb-4 text-gray-800">Nuevo local</h1>
					...
					<div class="form-row">
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
							<div class="form-label-group">
								...
								<input type="text" id="loc_nombre" name="loc_nombre" class="form-control" placeholder="Nombre local" autocomplete="off" value="">
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
							<div class="form-label-group">
								<label for="loc_direccion"><small>Direccion</small></label>
								<input type="text" id="loc_direccion" name="loc_direccion" class="form-control" placeholder="Direccion local" required="required" autocomplete="off" value="">
							</div>
						</div>
					</div>
				</div>
