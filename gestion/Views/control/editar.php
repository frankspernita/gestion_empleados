<body id="page-top">
	...
	<div id="wrapper">
		...
		<div class="container-fluid">
			...
			<!-- Page Heading -->
			<h1 class="h3 mb-4 text-gray-800">Editar item "<?php echo $row['it_descripcion'];?>"</h1>
			<form action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-row">
						<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
							<div class="selector-categoria">
								<input type="hidden" id="idcategoria1" name="idcategoria1" value="<?php echo isset($row)?($row['idcategoria']?:''):''; ?>">
					...
					<div class="form-row">
						<!-- <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
							<div class="form-label-group">
								...
								<input type="text" id="it_nombre" name="it_nombre" class="form-control" placeholder="Subcategoría" autocomplete="off" value="< ?php if (isset($row)) {
																																									echo $row['it_nombre'];
																																								} else {
																																									if ($_SESSION['it_nombre']) {
																																										echo $_SESSION['it_nombre'];
																																									}
																																								} ?> ">
							</div>
						</div> -->
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
							<div class="form-label-group">
								...
								<input type="text" id="it_descripcion" name="it_descripcion" class="form-control" placeholder="Nombre item" required="required" autocomplete="off" value="<?php if (isset($row)) {
																																																echo $row['it_descripcion'];
																																															} else {
																																																if ($_SESSION['it_descripcion']) {
																																																	echo $_SESSION['it_descripcion'];
																																																}
																																															} ?> ">
							</div>
						</div>
				...
				<br>
				<input type="hidden" id="iditem" name="iditem" value="<?php echo $row['iditem']; ?>">
				<label>Seleccione los locales para los cuales <strong>NO</strong> se aplica este item:</label>
				<div class="form-group">
					<div class="form-row">
						<div class="locales col-xs-12 col-sm-12 col-md-6 col-lg-6">
						</div>
					</div>
				</div>
				<br>
