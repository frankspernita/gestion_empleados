...
<?php include 'h_barra.php'; ?>
  ...
  <div id="wrapper">
    <!-- Begin Page Content -->
      ...
      <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Nuevo proveedor</h1>
                ...
                <div class="form-row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="form-label-group">
                            <label for="prov_nombre"><small>Proveedor</small></label>
                            <input type="text" id="prov_nombre" name="prov_nombre" autofocus="autofocus" class="form-control" placeholder="Nombre del proveedor" required="required" autocomplete="off" value="<?php echo $row['prov_nombre']; ?>">
                        </div>
                    </div>
                </div>
            </div>
